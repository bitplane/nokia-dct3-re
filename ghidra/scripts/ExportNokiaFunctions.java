...
public class ExportNokiaFunctions extends GhidraScript {
	...
	private static final Label[] LABELS = new Label[] {
		...
		new Label("service_session_case_e2_event_source_update_2379e8", 0x002379e8L),
		new Label("service_session_case_e1_clear_display_state_2379f2", 0x002379f2L),
		new Label("service_session_case_de_powerdown_reset_2379fa", 0x002379faL),
		new Label("service_session_case_dd_start_service_sweep_237a18", 0x00237a18L),
		new Label("service_session_case_dc_schedule_event1c_237a70", 0x00237a70L),
		new Label("service_session_case_db_common_reset_state_237a7a", 0x00237a7aL),
		new Label("service_session_case_da_status_update_237ade", 0x00237adeL),
		new Label("service_session_d9_5f00_request_call_2379a4", 0x002379a4L),
		new Label("service_session_d9_dispatch_after_5f00_request_2379aa", 0x002379aaL),
		new Label("service_session_case_d9_watchdog_poll_237b28", 0x00237b28L),
		new Label("service_session_case_df_e0_noop_237ba8", 0x00237ba8L),
		...
		new Label("service_session_timeout_entry_arg2_236dc4", 0x00236dc4L),
		new Label("service_session_timeout_build_fatal64_236dd4", 0x00236dd4L),
		new Label("service_session_timeout_set_detail45_236df2", 0x00236df2L),
		new Label("service_session_timeout_mark_status_bit0_236e24", 0x00236e24L),
		new Label("service_session_timeout_queue_fatal_236f44", 0x00236f44L),
		new Label("service_session_mode7_event_loop_237bb6", 0x00237bb6L),
		new Label("service_session_mode7_recv_next_message_237bc6", 0x00237bc6L),
		new Label("service_session_mode7_dispatch_message_237bca", 0x00237bcaL),
		new Label("service_session_mode7_frame_type_dispatch_237bde", 0x00237bdeL),
		new Label("service_session_mode7_non40_status_or_reply_237c46", 0x00237c46L),
		new Label("service_session_mode7_channel_reply_237c54", 0x00237c54L),
		new Label("service_session_mode7_status40_dispatch_237c70", 0x00237c70L),
		new Label("service_session_mode7_unknown_response_drop_237c88", 0x00237c88L),
		new Label("service_session_d9_ack_byte_check_237b42", 0x00237b42L),
		new Label("service_session_d9_ack_resets_watchdog_counter_237b4e", 0x00237b4eL),
		new Label("service_session_d9_counter_reset_or_increment_237b50", 0x00237b50L),
		new Label("service_session_d9_posts_event19_237b2e", 0x00237b2eL),
		new Label("service_session_d9_self_rearm_event19_237b32", 0x00237b32L),
		new Label("service_session_da_clears_startup_bits40_04_237b04", 0x00237b04L),
		new Label("service_session_timeout_threshold_237b7c", 0x00237b7cL),
		new Label("service_session_d9_timeout_arg2_call_237b80", 0x00237b80L),
		...
		new Label("service_session_terminal_reason_store_2b4e08", 0x002b4e08L),
		new Label("service_session_terminal_mad2_reset_or_2b4e12", 0x002b4e12L),
		new Label("service_session_display_request_7105_25edea", 0x0025edeaL),
		new Label("service_session_display_done_posts_event32_2abd88", 0x002abd88L),
		...
		new Label("display_nv_records_load_29a996", 0x0029a996L),
		new Label("display_profile_update_29ae68", 0x0029ae68L),
		new Label("display_capability_record_sanitize_2b5eaa", 0x002b5eaaL),
		new Label("display_profile_setup_message_init_2b1e80", 0x002b1e80L),
	...
	private static final Target[] TARGETS = new Target[] {
		...
		new Target("service_session_d9_e2_command_dispatch_237994", 0x00237994L),
		new Target("service_session_unknown_response_237960", 0x00237960L),
		new Target("service_session_response_dispatch_237400", 0x00237400L),
		new Target("service_session_mode7_loop_237bb4", 0x00237bb4L),
		new Target("service_session_mode7_non40_handler_237c46", 0x00237c46L),
		...
		new Target("service_session_task_loop_237bb4", 0x00237bb4L),
		new Target("service_session_event_237c96", 0x00237c96L),
		new Target("service_session_state_alloc_234634", 0x00234634L),
		new Target("service_session_state_release_234684", 0x00234684L),
		new Target("service_session_state_init_2346b2", 0x002346b2L),
		new Target("service_session_nv_pair_read_234588", 0x00234588L),
		...
		new Target("service_session_optional_flag_295ea2", 0x00295ea2L),
		...
		new Target("display_nv_records_load_29a996", 0x0029a996L),
		new Target("display_profile_update_29ae68", 0x0029ae68L),
		new Target("display_capability_record_sanitize_2b5eaa", 0x002b5eaaL),
		new Target("display_profile_setup_message_init_2b1e80", 0x002b1e80L),
		...
		new Target("service_session_display_request_7105_25edc0", 0x0025edc0L),
		new Target("service_session_draw_text_25edf2", 0x0025edf2L),
		new Target("service_session_draw_end_2abd7c", 0x002abd7cL),
		new Target("startup_mode1_post_event30_or_32_2abd90", 0x002abd90L),
		new Target("service_session_timeout_signal_236dc4", 0x00236dc4L),
		...
		new Target("service_session_startup_fault_status_builder_234720", 0x00234720L),
		...
		new Target("service_session_checksum_2a41d0", 0x002a41d0L),
		...
		new Target("mad2_interrupt_control_lock_2aa8fa", 0x002aa8faL),
		new Target("mad2_interrupt_control_unlock_2aa914", 0x002aa914L),
		...
		// --- Service-startup / DSP-handshake chain ---
		...
		// --- PM / service-node read layer + service-session response path ---
		...
		new Target("service_session_result_handler_2355b6", 0x002355b6L),
		...
		new Target("service_session_response_dispatch_236dc6", 0x00236dc6L),

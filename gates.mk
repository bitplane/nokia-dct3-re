...
# 270 gates: 141 generated from typed steps, 129 copied verbatim (shell).
...
DCT3_PRESS_180_250 := NOKIA_DCT3_POST_READY_KEY_DURATION_MS=180 NOKIA_DCT3_POST_READY_KEY_GAP_MS=250
...
.PHONY: verify-gsm-fr-codec verify-gsm-tch-f-l1 verify-gsm-a3a8 verify-gsm-a5 \
	...
	verify-radio-outgoing-sms-host-adapter verify-radio-outgoing-sms \
	...
	verify-sim-toolkit-browser verify-sim-toolkit-timer \
...
verify-3410-radio-handover: normalize-3410
	@set -e; \
...
# shell: NHM-2 handover rollback with mid-procedure save/load
verify-3410-radio-handover-failure-state: normalize-3410
	@set -e; \
...
# shell: NSE-8 A5/1 handover rollback and save/load
verify-radio-a5-1-handover-failure-state:
	@set -e; \
	$(DCT3_EEPROM_GUARD) \
	$(MAKE) --no-print-directory run RUN_DIR=$(RUN_DIR) SECONDS=30 ERASED_IDENTITY_SECURITY_CODE=12345 RUN_VERBOSE=1 \
...
# shell: NHM-5 A5/1 dedicated-mode handover success
verify-3310-radio-a5-1-handover:
	@set -e; \
	$(MAKE) --no-print-directory run $(DCT3_RUN_3310) RUN_DIR=$(RUN_DIR) SECONDS=30 RUN_VERBOSE=1 \
		RUN_EXTRA_ARGS='-cfg_directory ../fixtures/radio_a5_1_handover' \
		RUN_ENV='NOKIA_DCT3_POST_READY_KEYS=navi,wait9000,navi NOKIA_DCT3_POST_READY_KEY_DELAY_MS=18000 $(DCT3_PRESS_200_200)'; \
...
# shell: NHM-5 A5/1 handover rollback and save/load
verify-3310-radio-a5-1-handover-failure-state:
	@set -e; \
	$(MAKE) --no-print-directory run $(DCT3_RUN_3310) RUN_DIR=$(RUN_DIR) SECONDS=25 RUN_VERBOSE=1 \
		RUN_EXTRA_ARGS='-cfg_directory ../fixtures/radio_a5_1_handover_failure' \
...
# shell: NHM-6 A5/1 dedicated-mode handover success
verify-3330-radio-a5-1-handover: normalize-3330
	@set -e; \
	$(MAKE) --no-print-directory run $(DCT3_RUN_3330) RUN_DIR=$(RUN_DIR)_provision SECONDS=44 \
		RUN_ENV='$(NOKI3330_FIRST_BOOT_INPUT) NOKIA_DCT3_POST_READY_KEYS=$(NOKI3330_FIRST_BOOT_KEYS) NOKIA_DCT3_POST_READY_CAPTURE_DELAY_MS=7000'; \
	$(MAKE) --no-print-directory run $(DCT3_RUN_3330) RUN_DIR=$(RUN_DIR)_call SECONDS=22 RUN_VERBOSE=1 PRESERVE_NVRAM=1 \
...
# shell: NHM-6 A5/1 handover rollback and save/load
verify-3330-radio-a5-1-handover-failure-state: normalize-3330
	@set -e; \
	$(MAKE) --no-print-directory run $(DCT3_RUN_3330) RUN_DIR=$(RUN_DIR)_provision SECONDS=44 \
		RUN_ENV='$(NOKI3330_FIRST_BOOT_INPUT) NOKIA_DCT3_POST_READY_KEYS=$(NOKI3330_FIRST_BOOT_KEYS) NOKIA_DCT3_POST_READY_CAPTURE_DELAY_MS=7000'; \
	$(MAKE) --no-print-directory run $(DCT3_RUN_3330) RUN_DIR=$(RUN_DIR)_call SECONDS=18 RUN_VERBOSE=1 PRESERVE_NVRAM=1 \
...
# shell: NHM-2 A5/1 dedicated-mode handover success
verify-3410-radio-a5-1-handover: normalize-3410
	@set -e; \
	$(MAKE) --no-print-directory run $(DCT3_RUN_3410) RUN_DIR=$(RUN_DIR) SECONDS=25 RUN_VERBOSE=1 \
		RUN_EXTRA_ARGS='-cfg_directory ../fixtures/radio_a5_1_handover' \
		RUN_ENV='NOKIA_DCT3_POST_READY_KEYS=end,waitalerting,send,wait5000,end NOKIA_DCT3_POST_READY_KEY_DELAY_MS=1000 $(DCT3_PRESS_200_300)'; \
...
# shell: NHM-2 A5/1 handover rollback and save/load
verify-3410-radio-a5-1-handover-failure-state: normalize-3410
	@set -e; \
...
verify-radio-outgoing-sms-host-adapter:
	@set -e; \
	$(DCT3_EEPROM_GUARD) \
	$(MAKE) --no-print-directory build JOBS=$(JOBS) \
	...
	$(call prepare_host_run,$(RUN_DIR),noki3210,); \
	env NOKIA_DCT3_LUA_QUIET=1 \
		NOKIA_DCT3_POST_READY_KEYS=enter,wait800,down,wait800,enter,wait800,down,wait800,down,wait800,enter,wait800,4,4,wait1500,4,4,4,wait1500,enter,wait1000,enter,wait1000,5,5,5,1,2,3,4,wait800,enter \
		NOKIA_DCT3_POST_READY_KEY_DELAY_MS=12000 \
		$(DCT3_PRESS_180_300) \
		NOKIA_DCT3_SNAPSHOT_DIR=$(abspath $(RUN_DIR)) \
...
# shell: embedded EEPROM restoration guard
verify-radio-outgoing-sms-smsc:
	@set -e; \
	$(DCT3_EEPROM_GUARD) \
	$(MAKE) --no-print-directory run-captured $(DCT3_RUN_3210) RUN_DIR=$(RUN_DIR) SECONDS=92 \
		PROVISIONED_IMEI_PREFIX=49015420323751 RUN_VERBOSE=1 \
		RUN_ENV='NOKIA_DCT3_POST_READY_KEYS=enter,wait700,down,wait700,enter,wait700,down,wait500,down,wait500,down,wait500,down,wait700,enter,wait800,enter,wait800,enter,wait800,c,wait250,c,wait250,c,wait250,c,wait250,c,wait250,c,wait250,c,wait250,c,wait250,c,wait250,c,wait250,c,wait250,9,8,7,6,5,4,3,2,1,0,wait800,enter,wait1200,c,wait600,c,wait600,c,wait600,c,wait1000,enter,wait800,down,wait800,enter,wait800,down,wait800,down,wait800,enter,wait800,4,4,wait1500,4,4,4,wait1500,enter,wait1000,enter,wait1000,5,5,5,1,2,3,4,wait800,enter NOKIA_DCT3_POST_READY_KEY_DELAY_MS=12000 $(DCT3_PRESS_180_250) NOKIA_DCT3_POST_READY_CAPTURE_DELAY_MS=1200'; \
	$(PYTHON) tools/radio_outgoing_sms_smsc_trace_check.py $(RUN_DIR)/error.log \
		$(RUN_DIR)/nvram/noki3210/sim_card
	@echo "OK - physical 3210 EF_SMSP edit controlled mobile-originated SMS"
...
verify-radio-outgoing-sms-timeout-state:
	...
	$(MAKE) --no-print-directory run-captured $(DCT3_RUN_3210) RUN_DIR=$(RUN_DIR) SECONDS=88 \
		PROVISIONED_IMEI_PREFIX=49015420323751 RUN_VERBOSE=1 \
		RUN_EXTRA_ARGS='-cfg_directory ../fixtures/radio_sms_cp_silence' \
		RUN_ENV='NOKIA_DCT3_POST_READY_KEYS=enter,wait800,down,wait800,enter,wait800,down,wait800,down,wait800,enter,wait800,4,4,wait1500,4,4,4,wait1500,enter,wait1000,enter,wait1000,5,5,5,1,2,3,4,wait800,enter NOKIA_DCT3_POST_READY_KEY_DELAY_MS=12000 $(DCT3_PRESS_180_300) NOKIA_DCT3_POST_READY_CAPTURE_DELAY_MS=1200 NOKIA_DCT3_STATE_ROUNDTRIP_AT=40 NOKIA_DCT3_STATE_ROUNDTRIP_REPLAY_MS=1000 NOKIA_DCT3_STATE_ROUNDTRIP_END_DELAY_MS=40000'; \
	$(PYTHON) tools/radio_outgoing_sms_timeout_state_trace_check.py $(RUN_DIR)/error.log $(RUN_DIR)
	@echo "OK - physical outgoing-SMS CP wait survived save-state restoration"

# shell: embedded EEPROM restoration guard
verify-radio-outgoing-sms-delivery-report:
	@set -e; \
	$(DCT3_EEPROM_GUARD) \
	$(MAKE) --no-print-directory run-captured $(DCT3_RUN_3210) RUN_DIR=$(RUN_DIR) SECONDS=75 \
		PROVISIONED_IMEI_PREFIX=49015420323751 RUN_VERBOSE=1 \
		RUN_ENV='NOKIA_DCT3_POST_READY_KEYS=enter,wait700,down,wait700,enter,wait700,down,wait500,down,wait500,down,wait500,down,wait700,enter,wait800,down,wait500,down,wait700,enter,wait800,enter,wait600,down,wait600,enter,wait1200,c,wait600,c,wait600,c,wait600,c,wait600,c,wait600,c,wait600,c,wait600,enter,wait800,down,wait800,enter,wait800,down,wait800,down,wait800,enter,wait800,4,4,wait1500,4,4,4,wait1500,enter,wait1000,enter,wait1000,5,5,5,1,2,3,4,wait800,enter NOKIA_DCT3_POST_READY_KEY_DELAY_MS=12000 $(DCT3_PRESS_180_250) NOKIA_DCT3_POST_READY_CAPTURE_DELAY_MS=1200'; \
	$(PYTHON) tools/radio_outgoing_sms_delivery_report_trace_check.py \
		$(RUN_DIR)/error.log $(RUN_DIR)/nvram/noki3210/sim_card
	@echo "OK - requested SMS delivery report completed organically"

# shell: embedded EEPROM restoration guard
verify-radio-outgoing-sms-v501:
	@set -e; \
	$(DCT3_EEPROM_GUARD) \
	$(MAKE) --no-print-directory run-captured $(DCT3_RUN_3210_V501) RUN_DIR=$(RUN_DIR) SECONDS=65 \
		PROVISIONED_IMEI_PREFIX=49015420323751 RUN_VERBOSE=1 \
		RUN_ENV='NOKIA_DCT3_POST_READY_KEYS=enter,wait800,down,wait800,enter,wait800,down,wait800,down,wait800,enter,wait800,4,4,wait1500,4,4,4,wait1500,enter,wait1000,enter,wait1000,5,5,5,1,2,3,4,wait800,enter NOKIA_DCT3_POST_READY_KEY_DELAY_MS=12000 $(DCT3_PRESS_180_300) NOKIA_DCT3_POST_READY_CAPTURE_DELAY_MS=1200'; \
...
# shell: virgin-PMM setup plus physical predictive-text composer
verify-3330-radio-outgoing-sms: normalize-3330
	@set -e; \
	$(MAKE) --no-print-directory run-captured $(DCT3_RUN_3330) RUN_DIR=$(RUN_DIR) SECONDS=85 RUN_VERBOSE=1 \
		RUN_ENV='$(NOKI3330_FIRST_BOOT_INPUT) NOKIA_DCT3_POST_READY_KEYS=$(NOKI3330_FIRST_BOOT_KEYS),wait4000,enter,wait800,down,wait800,enter,wait800,enter,wait800,2,wait1500,enter,wait1200,enter,wait1500,5,5,5,1,2,3,4,wait1000,enter NOKIA_DCT3_POST_READY_CAPTURE_DELAY_MS=1200'; \
	$(PYTHON) tools/radio_outgoing_sms_product_trace_check.py $(RUN_DIR)/error.log $(RUN_DIR) nhm6
	@echo "OK - physical 3330 outgoing SMS completed"

# shell: three-softkey physical composer route
verify-3410-radio-outgoing-sms: normalize-3410
	@set -e; \
	$(MAKE) --no-print-directory run-captured $(DCT3_RUN_3410) RUN_DIR=$(RUN_DIR) SECONDS=75 RUN_VERBOSE=1 \
		RUN_ENV='NOKIA_DCT3_POST_READY_KEYS=end,wait4000,enter,wait1500,enter,wait1500,enter,wait3000,2,wait2000,enter,wait2000,enter,wait2000,5,5,5,1,2,3,4,wait1200,enter NOKIA_DCT3_POST_READY_KEY_DELAY_MS=16000 NOKIA_DCT3_POST_READY_KEY_DURATION_MS=250 NOKIA_DCT3_POST_READY_KEY_GAP_MS=500 NOKIA_DCT3_POST_READY_CAPTURE_DELAY_MS=1500'; \
	$(PYTHON) tools/radio_outgoing_sms_product_trace_check.py $(RUN_DIR)/error.log $(RUN_DIR) nhm2
	@echo "OK - physical 3410 outgoing SMS completed"
...
# shell: card menu and proactive SMS through the physical GSM stack
verify-sim-toolkit-sms:
	@set -e; \
	$(DCT3_EEPROM_GUARD) \
	mkdir -p $(RUN_DIR)/cfg; cp fixtures/sim_toolkit/default.cfg fixtures/sim_toolkit_sms/noki3210.cfg $(RUN_DIR)/cfg/; \
	...
	$(PYTHON) tools/sim_toolkit_sms_trace_check.py $(RUN_DIR)/error.log

# shell: card menu and proactive call through physical GSM call control
verify-sim-toolkit-call:
	@set -e; \
	$(DCT3_EEPROM_GUARD) \
	mkdir -p $(RUN_DIR)/cfg; cp fixtures/sim_toolkit/default.cfg fixtures/sim_toolkit_call/noki3210.cfg $(RUN_DIR)/cfg/; \
	...
	$(PYTHON) tools/sim_toolkit_call_trace_check.py $(RUN_DIR)/error.log

# shell: card menu and physical proactive item selection
verify-sim-toolkit-select-item:
	@set -e; \
	$(DCT3_EEPROM_GUARD) \
	mkdir -p $(RUN_DIR)/cfg; cp fixtures/sim_toolkit/default.cfg fixtures/sim_toolkit_select_item/noki3210.cfg $(RUN_DIR)/cfg/; \
	$(MAKE) --no-print-directory run-captured $(DCT3_RUN_3210) RUN_DIR=$(RUN_DIR) SECONDS=48 PROVISIONED_IMEI_PREFIX=49015420323751 RUN_VERBOSE=1 RUN_EXTRA_ARGS='-cfg_directory $(abspath $(RUN_DIR))/cfg' RUN_ENV='NOKIA_DCT3_POST_READY_KEYS=wait14000,enter,wait1200,5,wait500,enter,wait1200,4,2,wait500,enter,wait1500,enter,down,down,down,down,down,down,down,down,down,wait1000,enter,wait1000,enter,wait1500,down,wait500,enter NOKIA_DCT3_POST_READY_KEY_DELAY_MS=500 NOKIA_DCT3_POST_READY_KEY_DURATION_MS=220 NOKIA_DCT3_POST_READY_KEY_GAP_MS=500'; \
	$(PYTHON) tools/sim_toolkit_select_item_trace_check.py $(RUN_DIR)/error.log

# shell: negative 3210 SET UP EVENT LIST capability fixture
verify-sim-toolkit-event-list:
	@set -e; \
	$(DCT3_EEPROM_GUARD) \
...
# shell: proactive polling interval and polling-off lifecycle
verify-sim-toolkit-polling:
	@set -e; \
	$(DCT3_EEPROM_GUARD) \
	mkdir -p $(RUN_DIR)/cfg; cp fixtures/sim_toolkit/default.cfg fixtures/sim_toolkit_polling/noki3210.cfg $(RUN_DIR)/cfg/; \
	$(MAKE) --no-print-directory run-captured $(DCT3_RUN_3210) RUN_DIR=$(RUN_DIR) SECONDS=52 PROVISIONED_IMEI_PREFIX=49015420323751 RUN_VERBOSE=1 RUN_EXTRA_ARGS='-cfg_directory $(abspath $(RUN_DIR))/cfg' RUN_ENV='NOKIA_DCT3_POST_READY_KEYS=wait14000,enter,wait1200,5,wait500,enter,wait1200,4,2,wait500,enter,wait1500,enter,down,down,down,down,down,down,down,down,down,wait1000,enter,wait1000,enter NOKIA_DCT3_POST_READY_KEY_DELAY_MS=500 NOKIA_DCT3_POST_READY_KEY_DURATION_MS=220 NOKIA_DCT3_POST_READY_KEY_GAP_MS=500'; \
	$(PYTHON) tools/sim_toolkit_polling_trace_check.py $(RUN_DIR)/error.log

# shell: proactive DSP tone playback and physical cancellation
verify-sim-toolkit-tone:
	@set -e; \
	$(DCT3_EEPROM_GUARD) \
...
# shell: LAUNCH BROWSER capability boundary
verify-sim-toolkit-browser:
	@set -e; \
	$(DCT3_EEPROM_GUARD) \
	mkdir -p $(RUN_DIR)/cfg; cp fixtures/sim_toolkit/default.cfg fixtures/sim_toolkit_browser/noki3210.cfg $(RUN_DIR)/cfg/; \
	$(MAKE) --no-print-directory run-captured $(DCT3_RUN_3210) RUN_DIR=$(RUN_DIR) SECONDS=48 PROVISIONED_IMEI_PREFIX=49015420323751 RUN_VERBOSE=1 RUN_EXTRA_ARGS='-cfg_directory $(abspath $(RUN_DIR))/cfg' RUN_ENV='NOKIA_DCT3_POST_READY_KEYS=wait14000,enter,wait1200,5,wait500,enter,wait1200,4,2,wait500,enter,wait1500,enter,down,down,down,down,down,down,down,down,down,wait1000,enter,wait1000,enter NOKIA_DCT3_POST_READY_KEY_DELAY_MS=500 NOKIA_DCT3_POST_READY_KEY_DURATION_MS=220 NOKIA_DCT3_POST_READY_KEY_GAP_MS=500'; \
	$(PYTHON) tools/sim_toolkit_browser_trace_check.py $(RUN_DIR)/error.log

# shell: TIMER MANAGEMENT capability boundary
verify-sim-toolkit-timer:
	@set -e; \
	$(DCT3_EEPROM_GUARD) \
	mkdir -p $(RUN_DIR)/cfg; cp fixtures/sim_toolkit/default.cfg fixtures/sim_toolkit_timer/noki3210.cfg $(RUN_DIR)/cfg/; \
	$(MAKE) --no-print-directory run-captured $(DCT3_RUN_3210) RUN_DIR=$(RUN_DIR) SECONDS=48 PROVISIONED_IMEI_PREFIX=49015420323751 RUN_VERBOSE=1 RUN_EXTRA_ARGS='-cfg_directory $(abspath $(RUN_DIR))/cfg' RUN_ENV='NOKIA_DCT3_POST_READY_KEYS=wait14000,enter,wait1200,5,wait500,enter,wait1200,4,2,wait500,enter,wait1500,enter,down,down,down,down,down,down,down,down,down,wait1000,enter,wait1000,enter NOKIA_DCT3_POST_READY_KEY_DELAY_MS=500 NOKIA_DCT3_POST_READY_KEY_DURATION_MS=220 NOKIA_DCT3_POST_READY_KEY_GAP_MS=500'; \
	$(PYTHON) tools/sim_toolkit_timer_trace_check.py $(RUN_DIR)/error.log

# shell: unknown required proactive TLV rejection
verify-sim-toolkit-malformed:
	@set -e; \
	$(DCT3_EEPROM_GUARD) \
	mkdir -p $(RUN_DIR)/cfg; cp fixtures/sim_toolkit/default.cfg fixtures/sim_toolkit_malformed/noki3210.cfg $(RUN_DIR)/cfg/; \
	$(MAKE) --no-print-directory run-captured $(DCT3_RUN_3210) RUN_DIR=$(RUN_DIR) SECONDS=48 PROVISIONED_IMEI_PREFIX=49015420323751 RUN_VERBOSE=1 RUN_EXTRA_ARGS='-cfg_directory $(abspath $(RUN_DIR))/cfg' RUN_ENV='NOKIA_DCT3_POST_READY_KEYS=wait14000,enter,wait1200,5,wait500,enter,wait1200,4,2,wait500,enter,wait1500,enter,down,down,down,down,down,down,down,down,down,wait1000,enter,wait1000,enter NOKIA_DCT3_POST_READY_KEY_DELAY_MS=500 NOKIA_DCT3_POST_READY_KEY_DURATION_MS=220 NOKIA_DCT3_POST_READY_KEY_GAP_MS=500'; \
	$(PYTHON) tools/sim_toolkit_malformed_trace_check.py $(RUN_DIR)/error.log

# shell: firmware-owned unattended DISPLAY TEXT timeout
verify-sim-toolkit-timeout:
	@set -e; \
	$(DCT3_EEPROM_GUARD) \
	mkdir -p $(RUN_DIR)/cfg; cp fixtures/sim_toolkit/default.cfg fixtures/sim_toolkit/noki3210.cfg $(RUN_DIR)/cfg/; \
	$(MAKE) --no-print-directory run-captured $(DCT3_RUN_3210) RUN_DIR=$(RUN_DIR) SECONDS=85 PROVISIONED_IMEI_PREFIX=49015420323751 RUN_VERBOSE=1 RUN_EXTRA_ARGS='-cfg_directory $(abspath $(RUN_DIR))/cfg'; \
	$(PYTHON) tools/sim_toolkit_timeout_trace_check.py $(RUN_DIR)/error.log

...
test-tools:
	...
	$(VENV)/bin/python -m unittest tools/test_sim_toolkit_menu_trace_check.py tools/test_sim_toolkit_sms_trace_check.py tools/test_sim_toolkit_call_trace_check.py tools/test_sim_toolkit_selection_trace_check.py

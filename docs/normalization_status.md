...
- The DSP/external-service peer contract is proved only for requests exercised by
  ...
  Dedicated-mode handover is independently gated on NSE-8, NHM-5 and NHM-6
  for success, rollback and mid-procedure save/load; NHM-2 confirmation and

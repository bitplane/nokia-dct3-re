...
- The DSP/external-service peer contract is proved only for requests exercised by
  ...
  Dedicated-mode handover is independently gated on NSE-8 for success,
  rollback and mid-procedure save/load; cross-ROM confirmation and broader
  inbound radio/L1 behavior remain open.

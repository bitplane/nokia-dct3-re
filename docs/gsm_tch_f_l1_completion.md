...
| Bad/erased frames | Both decoders report protected-frame validity; bad and FACCH-stolen intervals cross explicit BFI boundaries into isolated GSM 06.11 substitution and 320 ms muting; queue absence remains a distinct no-delivery state | Paired-ROM `make verify-radio-degraded-speech`: 20 impaired bursts/direction and 145 non-silent blocks each; handset/network concealment 12/5 on v6.00 and 11/5 on v5.01 before clean recovery |

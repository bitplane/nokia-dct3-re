...
| Organic physical downlink playback | Network 1 kHz speech crosses Layer 1, DSP decoding, MAD2 PCM, COBBA EAR and the product speaker route into an isolated host playback sink | Paired gate records mono 8 kHz PCM independently of the microphone: v6.00 peak/RMS 10461/648.2 and 5.32-second 1 kHz run; v5.01 9372/614.8 and 5.34 seconds |

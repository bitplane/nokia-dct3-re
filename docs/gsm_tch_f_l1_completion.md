...
| Bad/erased frames | Decoder reports protected-frame validity; invalid downlink speech is withheld from the codec | `make verify-radio-degraded-speech`: 20 impaired bursts, 10 induced bad blocks, later non-silent recovery |

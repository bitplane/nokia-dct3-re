...
| Nokia 3330 NHM-6 v4.50E | Yes | Yes | No | No | No | No | Partial | Fresh-PMM frontier, save-state and physical navigation gates pass after restoring NHM-6's organically requested compact DSP service-control completion. Radio and later product contracts remain unestablished; its application-service contract is still empty. |

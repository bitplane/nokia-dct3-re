...
| Nokia 3330 NHM-6 v4.50E | Yes | Yes | Yes | No | No | No | Partial | Fresh-PMM frontier, save-state and physical navigation gates pass. `verify-3330-radio-boundary` proves standards-shaped DCS SI1--SI4 publication and automatic-access selection; `verify-3330-radio-registration`, its preserved-NVRAM variant and the registration save-state gate prove organic CHANNEL REQUEST, Immediate Assignment, the NHM-6-correlated assigned-channel confirmation, LAPDm Location Updating, EF_LOCI persistence, clean RR release and deterministic steady camp. `verify-3330-radio-unsuitable-cells` independently rejects barred and unattainable-RXLEV cells before access. Paging, calls, media and product analogue wiring are not yet established. |

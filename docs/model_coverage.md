...
| Nokia 3330 NHM-6 v4.50E | Yes | Yes | No | No | No | No | No | `verify-3330-frontier` and `verify-3330-navigation` pass. Radio and later product contracts are not established; its external-service application contract remains empty. |
| Nokia 3410 NHM-2 v5.46E | Yes | Yes | No | No | No | No | No | `verify-3410-frontier` and the navigation/menu gates pass. Radio and later product contracts are not established; its external-service application contract remains empty. |

...
| Nokia 6110 NSE-3 family | No | No | No | No | No | No | No | The primary NSE-3/UE4 manuals establish a 1 MiB TE28F800 flash, 64 KiB SRAM, 8 KiB serial EEPROM, 84 x 48 display, dedicated five-by-five keypad, MIC2/EAR topology and a 1 MHz/8 kHz 13-in-16 PCM bus. These differ materially from the current declared machines and are catalogued in `docs/6110_bringup.md`. No local hashed ROM3/ROM4 v5.48 firmware or executable profile exists yet, so no runtime promotion is claimed. |

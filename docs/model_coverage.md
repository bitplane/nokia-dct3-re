...
| Nokia 3410 NHM-2 v5.46E | Yes | Yes | Yes | No | No | No | Partial | Fresh and preserved-PMM gates prove NHM-2 registration and paging through ARFCN-1 acquisition, SI1–SI4, Location Updating, EF_LOCI persistence, IMSI-derived PCH scheduling, Paging Response, RR release and steady camp. Save/load passes before acquisition, before page delivery and on both assigned-SDCCH exchanges. Barred/unattainable cells, mismatched assignment, wrong-group pages and invalid identities remain negative. Ringing, physical Answer/End, media and analogue-board contracts remain unestablished, so Call control is not promoted. |

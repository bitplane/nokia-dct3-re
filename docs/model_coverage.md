...
| Nokia 3310 NHM-5 v6.39 | Yes | Yes | Yes | No | No | No | No | `verify-dsp-bootstrap-3310`, `verify-3310-frontier`, `verify-3310-navigation`, `verify-3310-radio-registration`, `verify-3310-radio-paging`, and `verify-3310-radio-incoming-call-boundary`. Its typed `0x56` candidate search selects and camps on ARFCN `0x0058`; SI1--SI4, Random Access and Immediate Assignment remain firmware-owned. A correctly addressed page organically produces RACH and Paging Response. On the dedicated link v6.39 accepts Cipher Mode Command, publishes its distinct DSP type-`0x14` body, emits Cipher Mode Complete, accepts MM Information and receives the complete incoming CC SETUP. It does not yet emit Call Confirmed. Ringing, physical Answer/End and audio remain unproved; no 3210 call or audio assumptions are claimed. |

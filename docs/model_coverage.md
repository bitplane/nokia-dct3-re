...
| Nokia 3410 NHM-2 v5.46E | Yes | Yes | Yes | No | No | No | Partial | Fresh and preserved-PMM registration gates prove NHM-2's independent autonomous band-scan and compact external-service contracts through ARFCN-1 acquisition, SI1–SI4, Location Updating, EF_LOCI persistence, RR release and steady camp. Save/load passes before acquisition and on the assigned SDCCH; barred, unattainable-RXLEV and mismatched-assignment fixtures remain unregistered. Paging, calls, media and analogue-board contracts remain unestablished. |

...
| Nokia 3330 NHM-6 v4.50E | Yes | Yes | Yes | Yes | Yes | No | Partial | Fresh-PMM frontier, navigation, registration and paging gates pass. The incoming-call and media-resilience gates cold-boot preserved PMM, clear firmware-owned modal editors through physical keys, complete the call through physical Navi Answer/End and carry bidirectional GSM-FR over NHM-6's independently evidenced command-`0x08` speech field and COBBA-GJP 1 MHz/125-clock PCM link. FACCH substitution, bidirectional degraded frames, concealment, SACCH coexistence and exact active-call save-state replay pass before clean return to PCH. The combined NHM-2/5/6 repair material establishes the COBBA/audio boundary but does not identify the converter's fitted microphone input or prove host-level acoustics, so physical duplex remains unpromoted. |
| Nokia 3410 NHM-2 v5.46E | Yes | Yes | Yes | Yes | Yes | No | Partial | Fresh and preserved-PMM gates prove NHM-2 registration and paging through ARFCN-1 acquisition, SI1–SI4, Location Updating, EF_LOCI persistence, IMSI-derived PCH scheduling, Paging Response, RR release and steady camp. Save/load passes before acquisition, before page delivery and on both assigned-SDCCH exchanges. The incoming-call lifecycle gate proves firmware-driven MAD2 ringing, physical Send/End, Connect/Connect Acknowledge, one TCH assignment despite NHM-2's repeated Call Confirmed, standards-shaped CC/RR release and return to PCH. NHM-2 independently publishes command-`0x08` speech values `0x060b`/`0x040a`; its typed COBBA-GJP profile sustains timed 1 MHz/8 kHz 13-in-16 PCM and bidirectional GSM-FR with non-silent downlink before TCH-owned teardown. Barred/unattainable cells, mismatched assignment, wrong-group pages and invalid identities remain negative. The fitted analogue microphone and receiver routes remain unestablished, so physical duplex is not promoted. |

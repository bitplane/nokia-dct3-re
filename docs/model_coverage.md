...
| Nokia 3330 NHM-6 v4.50E | Partial | No | No | No | No | No | No | The virgin-PMM run reproducibly reaches a stable CONTACT SERVICE frame, but `verify-3330-frontier` and navigation currently disagree with their stored idle oracle (`7e3ade…` observed). Radio and later product contracts are not established; its external-service application contract remains empty. |
| Nokia 3410 NHM-2 v5.46E | Partial | No | No | No | No | No | No | The flash-compaction run is reproducible, but `verify-3410-frontier` currently disagrees with its stored idle oracle (`e25ff9…` observed). Interactive promotion is withheld until the blank/idle divergence and navigation gates are resolved. |

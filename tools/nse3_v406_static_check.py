...
RADIO_PACKET_ANCHORS = {
    ...
    0x20E9D8: ("ldrb", "r0, [r4, #0xf]"),
    0x20E9DA: ("cmp", "r0, #6"),
    0x20E9E2: ("cmp", "r0, #7"),
    0x20EA12: ("lsrs", "r1, r7, #8"),
    0x20EA14: ("strb", "r1, [r0, #0x12]"),
    0x20EA18: ("strb", "r7, [r0, #0x13]"),
    0x20EA6E: ("movs", "r0, #3"),
...
RADIO_REPORT_HANDLER_ANCHORS = {
    ...
    0x2803F8: ("push", "{r4, lr}"),
    0x2803FC: ("ldr", "r0, [pc, #0x60]"),
    0x2803FE: ("ldrb", "r1, [r0, #3]"),
    0x280400: ("cmp", "r1, #1"),
    0x280404: ("adds", "r0, r4, #0"),
    0x280406: ("bl", "#0x26069c"),
    0x28040C: ("movs", "r2, #0x7c"),
    0x280410: ("ldrb", "r3, [r1, r0]"),
    0x280412: ("movs", "r1, #0xfd"),
    0x280414: ("ands", "r1, r3"),
    0x280416: ("strb", "r1, [r2, r0]"),
    0x280418: ("ldr", "r0, [pc, #0x1ec]"),
    0x28041E: ("movs", "r1, #8"),
    0x280420: ("bl", "#0x276912"),
    0x280424: ("movs", "r0, #0xb"),
    0x280428: ("bl", "#0x25fb4c"),
    # Statuses 0x138f and 0x1390 intentionally converge on this task-11 case.
    # Its later progress path is controlled by shared flag bits, not by a
    # type-0x8a payload discriminator.
    0x211C94: ("subs", "r0, #1"),
    0x211C96: ("cmp", "r0, #1"),
    0x211C9A: ("b", "#0x211e48"),
    0x211E48: ("ldr", "r0, [sp, #0x18]"),
    0x211E4A: ("movs", "r1, #8"),
    0x211E4C: ("bl", "#0x27693c"),
    0x211E50: ("ldr", "r1, [r4, #0x7c]"),
    0x211E52: ("lsrs", "r0, r1, #0x1a"),
    0x211E56: ("ldr", "r2, [pc, #0x98]"),
    0x211E58: ("ldrh", "r0, [r2]"),
    0x211E5A: ("adds", "r0, #1"),
    0x211E5C: ("strh", "r0, [r2]"),
    0x211E5E: ("ldrb", "r0, [r4, #3]"),
    0x211E60: ("cmp", "r0, #1"),
    ...
    # Type 0x83 routes the same 0x2c-byte object by controller byte 0x1090ff:
    # value 1 discards it, value 3 posts 0x139f to task 11, and all other
    # values post 0x13a0 to task 12.
    0x27FD40: ("push", "{r4, lr}"),
    0x27FD44: ("ldr", "r0, [pc, #0x328]"),
    0x27FD46: ("ldrb", "r0, [r0]"),
    0x27FD48: ("cmp", "r0, #3"),
    0x27FD4C: ("cmp", "r0, #1"),
    ...
    0x27FD5A: ("bl", "#0x276912"),
    0x27FD5E: ("movs", "r0, #0xc"),
    0x27FD62: ("adds", "r0, r4, #0"),
    0x27FD64: ("bl", "#0x26069c"),
    0x27FD6A: ("ldr", "r0, [pc, #0x308]"),
    0x27FD6C: ("strh", "r0, [r4]"),
    0x27FD70: ("movs", "r1, #0x2c"),
    0x27FD72: ("bl", "#0x276912"),
    0x27FD76: ("movs", "r0, #0xb"),
    0x27FD7A: ("bl", "#0x25fb4c"),
    # Task 11 status 0x139f preserves only signed report byte 6 in a shared
    # scalar cell.
    0x210E0A: ("ldr", "r0, [pc, #0x3a4]"),
    0x210E0C: ("cmp", "r1, r0"),
    0x210E10: ("movs", "r0, #6"),
    0x210E12: ("ldrsb", "r0, [r0, r5]"),
    0x210E14: ("ldr", "r1, [pc, #0x39c]"),
    0x210E16: ("strb", "r0, [r1]"),
    # Task 12 recognizes status 0x13a0 before its later 0x13aa..0x13ba table.
    # It first updates a five-entry rolling scalar state from the report and
    # then selects product-local controller helpers by mode/state.
    0x217088: ("movs", "r1, #0x9d"),
    0x21708A: ("lsls", "r1, r1, #5"),
    0x21708C: ("cmp", "r0, r1"),
    0x217092: ("b", "#0x2173b0"),
    0x2173B0: ("adds", "r0, r4, #0"),
    0x2173B2: ("bl", "#0x21630c"),
    0x2173B6: ("ldr", "r0, [pc, #0x204]"),
    0x2173BA: ("cmp", "r0, #3"),
    0x2173BE: ("ldrb", "r0, [r6, #5]"),
    0x2173C0: ("cmp", "r0, #7"),
    0x2173C4: ("cmp", "r0, #6"),
    0x2173C8: ("bl", "#0x216424"),
    0x2173D8: ("adds", "r0, r4, #0"),
    0x2173DA: ("bl", "#0x216cb4"),
    0x21630C: ("push", "{r4, r5, r6, lr}"),
    0x216312: ("ldrb", "r0, [r5, #4]"),
    0x21631C: ("movs", "r0, #6"),
    0x21631E: ("ldrsb", "r0, [r0, r5]"),
    0x216328: ("movs", "r1, #7"),
    0x21632A: ("ldrsb", "r1, [r1, r5]"),
    0x216330: ("adds", "r0, r0, #1"),
    0x216332: ("movs", "r1, #5"),
    0x21633C: ("cmp", "r1, #5"),
    0x2163A8: ("ldrb", "r0, [r5, #8]"),
    0x2163AC: ("ldrb", "r0, [r5, #9]"),
    0x2163B0: ("movs", "r0, #0x1b"),
    ...
    0x215706: ("cmp", "r0, #0"),
    # Type 0x88 is discarded only at controller value 1.  Otherwise its
    # direct handler repacks the report into a fresh 16-byte status-0x13ac
    # object with one 24-bit value, two 16-bit values and two control bytes.
    0x280464: ("push", "{r4, r5, lr}"),
    0x280468: ("ldr", "r0, [pc, #0x194]"),
    0x28046A: ("ldrb", "r0, [r0]"),
    0x28046C: ("cmp", "r0, #1"),
    0x280470: ("movs", "r0, #0x10"),
    0x280472: ("bl", "#0x260abc"),
    0x280478: ("ldr", "r0, [pc, #0x198]"),
    0x28047A: ("strh", "r0, [r5]"),
    0x28047C: ("ldrb", "r1, [r4, #6]"),
    0x28047E: ("ldrb", "r0, [r4, #5]"),
    0x280484: ("lsls", "r1, r0, #8"),
    0x280486: ("ldrb", "r0, [r4, #7]"),
    0x28048A: ("str", "r0, [r5, #4]"),
    0x28048C: ("ldrb", "r0, [r4, #9]"),
    0x28048E: ("ldrb", "r1, [r4, #8]"),
    0x280494: ("strh", "r0, [r5, #8]"),
    0x280496: ("ldrb", "r1, [r4, #0xb]"),
    0x280498: ("ldrb", "r0, [r4, #0xa]"),
    0x28049E: ("strh", "r0, [r5, #0xa]"),
    0x2804A0: ("ldrb", "r0, [r4, #4]"),
    0x2804A2: ("strb", "r0, [r5, #0xc]"),
    0x2804A4: ("ldrb", "r0, [r4, #0xd]"),
    0x2804A6: ("strb", "r0, [r5, #0xd]"),
    0x2804AA: ("movs", "r1, #0x10"),
    0x2804AC: ("bl", "#0x276912"),
    0x2804B0: ("movs", "r0, #0xc"),
    0x2804B4: ("bl", "#0x25fb4c"),
    # Status 0x13ac selects a derived-scalar controller helper only in task
    # state 3/mode 2.  Other states can update matching 24-byte candidate
    # records through 0x2159b0.  Neither branch directly constructs a radio
    # request.
    0x2172D2: ("strb", "r7, [r5, #9]"),
    0x2172D4: ("ldr", "r0, [pc, #0x298]"),
    0x2172D8: ("cmp", "r0, #3"),
    0x2172DC: ("ldr", "r0, [pc, #0x2dc]"),
    0x2172E0: ("cmp", "r0, #2"),
    0x2172E6: ("ldrb", "r0, [r4, #0xc]"),
    0x2172EE: ("bl", "#0x212d24"),
    0x2172F2: ("movs", "r0, #1"),
    0x2172F4: ("bl", "#0x212088"),
    0x2172F8: ("ldrb", "r0, [r6, #5]"),
    0x2172FA: ("cmp", "r0, #7"),
    0x2172FE: ("ldrb", "r0, [r4, #0xc]"),
    0x217304: ("ldrb", "r0, [r4, #0xd]"),
    0x21730A: ("ldr", "r0, [pc, #0x2b4]"),
    0x21730E: ("ldr", "r0, [r4, #4]"),
    0x217312: ("ldr", "r0, [r4, #4]"),
    0x217318: ("ldr", "r0, [r4, #4]"),
    0x21716E: ("bl", "#0x2142b2"),
    0x21731E: ("ldrb", "r0, [r4, #0xc]"),
    0x217326: ("adds", "r0, r4, #0"),
    0x217328: ("bl", "#0x2159b0"),
    0x2159B0: ("push", "{r4, r5, r6, r7, lr}"),
    0x2159BA: ("ldr", "r2, [pc, #0xe4]"),
    0x2159BE: ("ldrh", "r3, [r6, #0xa]"),
    0x2159C8: ("ldr", "r0, [r6, #4]"),
    0x2159F8: ("ldrh", "r2, [r4, #0xa]"),
    0x2159FA: ("ldrh", "r3, [r6, #8]"),
    0x215A00: ("strb", "r7, [r4, #0xe]"),
    ...
    return {
        ...
        "report_dispatch": {
            ...
            "type_0x8a": {
                ...
                "acceptance_controller_byte": 0x1090FF,
                "discarded_controller_values": [1],
                "accepted_controller_values": "all_other_values",
                "cleared_shared_flag": {
                    "cell": 0x109178,
                    "mask": 0x02,
                },
                ...
                "shared_state_relationship": {
                    ...
                    "request_object_offsets": [0x12, 0x13],
                    "evidenced_controller_values": [6, 7],
                },
            ...
            "type_0x83": {
                ...
                "routes": {
                    ...
                    "controller_value_3": {
                        ...
                        "status": 0x139F,
                        "consumer": 0x210E0A,
                        "signed_report_byte_offset": 6,
                        "destination_cell": 0x10918D,
                    },
                    "all_other_controller_values": {
                        "task": 12,
                        "status": 0x13A0,
                        "consumer": 0x2173B0,
                        "rolling_scalar_aggregator": {
                            "routine": 0x21630C,
            ...
            "type_0x88": {
                ...
                "input_queue_object_offsets": {
                    "control_0": 4,
                    "value_24_be": [5, 6, 7],
                    "value_16_be_0": [8, 9],
                    "value_16_be_1": [0x0A, 0x0B],
                    "control_1": 0x0D,
                },
                "task": 12,
                "status": 0x13AC,
                "task_object_bytes": 0x10,
                "task_object_layout": {
                    "value_24": 4,
                    "value_16_0": 8,
                    "value_16_1": 0x0A,
                ...
                "state_3_mode_2_path": {
                    ...
                    "mode_cell": 0x106AF6,
                    "mode_value": 2,
                    "derived_value_helper": 0x2142B2,
                    "helper_can_arm_timer": 0x6E,
                },
                "other_state_path": {
                    "requires_control_0_zero": True,
                    "candidate_updater": 0x2159B0,
                    "candidate_record_bytes": 0x18,
                    "match_task_object_offset": 8,
                    "match_candidate_offset": 0x0A,
                    "updated_candidate_offsets": [8, 0x0E, 0x0F],
                },
                "direct_bitmap_search_constructor": None,
                "direct_channel_configure_constructor": None,
                "acquisition_terminal": False,

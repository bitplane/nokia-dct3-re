    ...
    def test_accepts_bad_frame_and_recovery(self):
        with TemporaryDirectory() as directory:
            ...
            lines = [
                ...
                "dsp_hle: speech tick uplink=50 downlink=47 pcm=50 pcm_clock=520000/8000 pcm_shape=65 serial_clocks=520000/384000 mic_peak=0 ear_peak=4096 nonzero=0/47 t=11.000000",
                ...
                "dsp_hle: speech tick uplink=103 downlink=101 pcm=103 pcm_clock=520000/8000 pcm_shape=65 serial_clocks=1071200/791040 mic_peak=0 ear_peak=4096 nonzero=0/101 t=12.020000",
            ]
            log.write_text("\n".join(lines))

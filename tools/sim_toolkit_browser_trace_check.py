#!/usr/bin/env python3
"""Check the 3210 LAUNCH BROWSER capability boundary."""
...
def main() -> None:
    ...
    try:
        ...
        raise SystemExit(f"SIM TOOLKIT BROWSER: FAIL: {error}") from error
    print("SIM TOOLKIT BROWSER: PASS command rejected as unsupported")

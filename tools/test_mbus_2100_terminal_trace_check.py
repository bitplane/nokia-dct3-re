...
GOOD = """
mbus_terminal: phone_frame type=d0 command=01 length=9 sequence=01 startup=0
mbus_terminal: tx_complete type=7f length=6
mbus_terminal: tx_complete type=d0 length=9
mbus_terminal: phone_frame type=d0 command=05 length=9 sequence=02 startup=1
mbus_terminal: tx_complete type=7f length=6
"""
